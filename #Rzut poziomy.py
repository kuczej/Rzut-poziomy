...
def read_datas():
    ...
    while v_start is None:
        v_start = float_input(
            ...
            "TTeraz podaj poprawną prędkość początkową (w m/s, min 2): ",
            2
            )
...
# Obliczamy kolejkne wartości Y dla X co 1/100 ogólnego zasięgu
x_points = np.arange(0, max_range, max_range / 100)
y_points = H_START - ((g / 2) * (x_points / V_START ) ** 2)

# DOdajemy wykres i umieszczamy punkty startu i upadku
